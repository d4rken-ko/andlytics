...
public class PreferenceActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ft.replace(android.R.id.content, new PreferenceActivityFragment());
		ft.commit();
	}

	@SuppressLint("ValidFragment")
	public class PreferenceActivityFragment extends PreferenceFragment implements
		...
		private void buildAccountsList() {
			developerAccounts = DeveloperAccountManager.getInstance(getActivity()).getActiveDeveloperAccounts();
